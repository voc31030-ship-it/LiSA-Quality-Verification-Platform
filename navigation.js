...
function injectLayout(session, currentPage) {
  ...
  if (mainContent) {
    ...
    header.innerHTML = `
      ...
      <div class="header-actions">
        ...
        <button class="btn-secondary" id="lisa-logout-btn" style="padding: 6px 12px; font-size: 13px; margin-left: 8px;">Logout</button>
  ...
  document.getElementById("lisa-logout-btn").addEventListener("click", () => {
